...
public class Correo
{
    ...
    public void enviarCorreo(String correoDestino, String userToken, String mensaje)
    {
        ...
        try
        {
            ...
            mail.From = new MailAddress("granjavtev2020@gmail.com", "Correo de Recuperación");
            ...
            SmtpServer.Credentials = new System.Net.NetworkCredential("granjavtev2020@gmail.com", "Granja@2020");
